...
for i, students_row in enumerate(students, start=2):  # start=2 para começar na linha 2 do Excel
    for j, students_col in enumerate(students_row, start=1):  # start=1 para começar na coluna 1 do Excel
